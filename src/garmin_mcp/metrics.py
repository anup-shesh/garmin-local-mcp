...
_METRICS = [
    ...
    # performance (Garmin's periodic fitness scores; not updated every day)
    Metric("endurance_score", "performance", "endurance_score"),
    Metric("endurance_class", "performance", "endurance_class", numeric=False),
    Metric("hill_score", "performance", "hill_score"),
    Metric("hill_endurance_score", "performance", "hill_endurance_score"),
    Metric("hill_strength_score", "performance", "hill_strength_score"),
    Metric("readiness_score", "performance", "readiness_score"),
    Metric("readiness_level", "performance", "readiness_level", numeric=False),
    Metric("recovery_time_min", "performance", "recovery_time_min"),
    Metric("race_5k_s", "performance", "race_5k_s"),
    Metric("race_10k_s", "performance", "race_10k_s"),
    Metric("race_half_s", "performance", "race_half_s"),
    Metric("race_marathon_s", "performance", "race_marathon_s"),
